...
<head>
  ...
  <style>
    ...
    .animate-fadeInUpTable {
      animation: fadeInUpTable 0.7s ease-out;
    }
  </style>
</head>
<body class="" action="{{route('home')}}">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <form method="POST" action="{{ route('logout') }}" style="display: inline;">
              @csrf
              <button type="submit"
                class="bg-white text-purple-600 hover:bg-purple-300 px-2 py-1 rounded-md shadow-md font-semibold inline-block">
                Logout
              </button>
            </form>
          </div>
  ...
  <div>
    <div class="overflow-x-auto p-4">
      <table class="min-w-full text-left text-sm bg-purple-50 rounded-lg shadow-md animate-fadeInUpTable">
        ...
        <tbody class="divide-y divide-purple-200">
          ...
          <tr>
            ...
            <td class="px-4 py-2 flex space-x-2">
              <a href="{{ route('edit', $post->id) }}" class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-300">Edit</a>
